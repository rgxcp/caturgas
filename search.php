...
$result = $mysqli->query("SELECT * FROM coba WHERE matkul LIKE '%$kataKunci%' OR deadline LIKE '%$kataKunci%' OR deadline LIKE '%$kataKunci%' ORDER BY id DESC") or die($mysqli->error);
